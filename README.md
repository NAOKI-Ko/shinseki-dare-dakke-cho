...
日本ストア600円のローカル商品を定義しています。Appleへの実課金なしで
確認する場合は、ローカルテスト時だけRun > Options > StoreKit Configurationで
このファイルを選択します。現在の共有Schemeは実機Sandbox／App Store Connectを
参照するため`None`のままです。ユニットテストでは
...
```
和帳シリーズ第3作「親戚だれだっけ帳」の新規プロジェクト構築です。
